...
####### Copy the external_ecc_key.pem file into machine 2, then do the following steps ###########


########## Generating the CA certificate on Machine 2 ###############################
...
############ Generating the TLS auth certificate on Machine 2 ##########################
